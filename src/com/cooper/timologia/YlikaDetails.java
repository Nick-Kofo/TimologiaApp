...
public class YlikaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumYlika();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε υλικά= " + data);
		} else {
			sum.setText("Σύνολο σε υλικά= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_YlikaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(YlikaDetails.this, timologia_data);
