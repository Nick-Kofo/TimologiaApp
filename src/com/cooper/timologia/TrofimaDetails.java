...
public class TrofimaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumTrofima();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε τρόφιμα= " + data);
		} else {
			sum.setText("Σύνολο σε τρόφιμα= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_TrofimaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(TrofimaDetails.this, timologia_data);
