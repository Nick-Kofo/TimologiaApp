...
public class Evdomada extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumEvdomada();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο εβδομάδας= " + data);
		} else {
			sum.setText("Σύνολο εβδομάδας= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Evdomada();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Evdomada.this, timologia_data);
