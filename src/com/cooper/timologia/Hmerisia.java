...
public class Hmerisia extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumHmerisia();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο ημέρας= " + data);
		} else {
			sum.setText("Σύνολο ημέρας= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Hmerisia();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Hmerisia.this, timologia_data);
