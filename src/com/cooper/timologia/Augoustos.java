...
public class Augoustos extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumAug();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Αυγούστου= " + data);
		} else {
			sum.setText("Σύνολο Αυγούστου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Augousto();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Augoustos.this, timologia_data);
