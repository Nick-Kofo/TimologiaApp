...
public class LikerDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumLiker();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε λικέρ= " + data);
		} else {
			sum.setText("Σύνολο σε λικέρ= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_LikerDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(LikerDetails.this, timologia_data);
