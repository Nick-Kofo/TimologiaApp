...
public class SinolikoPosoPromitheuti extends Activity implements OnItemSelectedListener {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumPromitheuti();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο προμηθευτή= " + data);
		} else {
			sum.setText("Σύνολο προμηθευτή= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_SpinnerDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(SinolikoPosoPromitheuti.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									SinolikoPosoPromitheuti.this.onResume();
