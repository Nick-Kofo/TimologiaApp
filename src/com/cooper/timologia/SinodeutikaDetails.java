...
public class SinodeutikaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumSinodeutika();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των συνοδευτικών= " + data);
		} else {
			sum.setText("Σύνολο συνοδευτικών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_SinodeutikaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(SinodeutikaDetails.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									SinodeutikaDetails.this.onResume();
