...
public class KrasiaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumKrasia();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε κρασιά= " + data);
		} else {
			sum.setText("Σύνολο σε κρασιά= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_KrasiaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(KrasiaDetails.this, timologia_data);
