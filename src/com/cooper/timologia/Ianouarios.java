...
public class Ianouarios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumIan();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Ιανουαρίου= " + data);
		} else {
			sum.setText("Σύνολο Ιανουαρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Ianouario();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Ianouarios.this, timologia_data);
