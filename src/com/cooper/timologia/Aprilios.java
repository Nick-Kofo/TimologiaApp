...
public class Aprilios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumApr();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Απριλίου= " + data);
		} else {
			sum.setText("Σύνολο Απριλίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Aprilio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Aprilios.this, timologia_data);
