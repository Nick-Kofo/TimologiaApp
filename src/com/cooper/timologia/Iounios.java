...
public class Iounios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumIou();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Ιουνίου= " + data);
		} else {
			sum.setText("Σύνολο Ιουνίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Iounio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Iounios.this, timologia_data);
