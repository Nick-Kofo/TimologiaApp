...
public class Dekevrios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumDek();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Δεκεμβρίου= " + data);
		} else {
			sum.setText("Σύνολο Δεκεμβρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Dekevrio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Dekevrios.this, timologia_data);
