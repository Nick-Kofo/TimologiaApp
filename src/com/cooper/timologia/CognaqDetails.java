...
public class CognaqDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumCognaq();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε κονιάκ= " + data);
		} else {
			sum.setText("Σύνολο σε κονιάκ= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_CognaqDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(CognaqDetails.this, timologia_data);
