...
public class Septevrios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumSep();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Σεπτεβρίου= " + data);
		} else {
			sum.setText("Σύνολο Σεπτεβρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Septevrio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Septevrios.this, timologia_data);
