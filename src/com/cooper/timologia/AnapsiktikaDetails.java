...
public class AnapsiktikaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumAnapsiktika();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των αναψυκτικών= " + data);
		} else {
			sum.setText("Σύνολο αναψυκτικών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_AnapsiktikaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(AnapsiktikaDetails.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									AnapsiktikaDetails.this.onResume();
