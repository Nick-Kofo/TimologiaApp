...
public class KafedesDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumKafedes();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε καφέδες= " + data);
		} else {
			sum.setText("Σύνολο σε καφέδες= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_KafedesDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(KafedesDetails.this, timologia_data);
