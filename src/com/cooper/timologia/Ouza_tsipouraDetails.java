...
public class Ouza_tsipouraDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumOuza_tsipoura();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε ούζα-τσίπουρα= " + data);
		} else {
			sum.setText("Σύνολο σε ούζα-τσίπουρα= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Ouza_tsipouraDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Ouza_tsipouraDetails.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									Ouza_tsipouraDetails.this.onResume();
