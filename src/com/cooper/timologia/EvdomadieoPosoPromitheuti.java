...
public class EvdomadieoPosoPromitheuti extends Activity implements OnItemSelectedListener {
	...
	TextView sum;
	Spinner spinner;
	public static String evdomadieoitem="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.promitheutes);
		try {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumPromitheutiEvdomadas();
		db.close();
		if (data != null) {
			sum.setText("Εβδομαδιαίο σύνολο προμηθευτή= " + data);
		} else {
			sum.setText("Εβδομαδιαίο σύνολο προμηθευτή= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_SpinnerDetailsEvdomadas();
		...
		db.close();
		tAdapter = new Timologia_Adapter(EvdomadieoPosoPromitheuti.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									EvdomadieoPosoPromitheuti.this.onResume();
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
			long id) {
		// TODO Auto-generated method stub
		evdomadieoitem = parent.getItemAtPosition(position).toString();
		Set_Referash_Data();
		Set_Sum_Tim();
