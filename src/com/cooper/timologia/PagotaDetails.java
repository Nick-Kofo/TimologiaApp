...
public class PagotaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumPagota();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των παγωτών= " + data);
		} else {
			sum.setText("Σύνολο παγωτών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_PagotaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(PagotaDetails.this, timologia_data);
