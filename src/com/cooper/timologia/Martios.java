...
public class Martios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumMar();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Μαρτίου= " + data);
		} else {
			sum.setText("Σύνολο Μαρτίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Martio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Martios.this, timologia_data);
