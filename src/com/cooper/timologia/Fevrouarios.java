...
public class Fevrouarios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumFeb();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Φεβρουαρίου= " + data);
		} else {
			sum.setText("Σύνολο Φεβρουαρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Fevrouario();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Fevrouarios.this, timologia_data);
