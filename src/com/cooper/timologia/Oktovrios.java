...
public class Oktovrios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumOkt();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Οκτωβρίου= " + data);
		} else {
			sum.setText("Σύνολο Οκτωβρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Oktovrio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Oktovrios.this, timologia_data);
