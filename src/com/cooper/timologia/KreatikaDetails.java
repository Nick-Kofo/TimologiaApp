...
public class KreatikaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumKreatika();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των κρεατικών= " + data);
		} else {
			sum.setText("Σύνολο κρεατικών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_KreatikaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(KreatikaDetails.this, timologia_data);
