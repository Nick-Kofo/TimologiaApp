...
public class Ioulios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumIul();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Ιουλίου= " + data);
		} else {
			sum.setText("Σύνολο Ιουλίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Ioulio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Ioulios.this, timologia_data);
