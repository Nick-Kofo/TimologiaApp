...
public class Noevrios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumNoe();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Νοεμβρίου= " + data);
		} else {
			sum.setText("Σύνολο Νοεμβρίου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Noevrio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Noevrios.this, timologia_data);
