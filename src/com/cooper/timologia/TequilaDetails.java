...
public class TequilaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumTequila();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε τεκίλα= " + data);
		} else {
			sum.setText("Σύνολο σε τεκίλα= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_TequilaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(TequilaDetails.this, timologia_data);
