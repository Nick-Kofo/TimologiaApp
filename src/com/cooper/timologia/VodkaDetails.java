...
public class VodkaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumVodka();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε βότκα= " + data);
		} else {
			sum.setText("Σύνολο σε βότκα= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_VodkaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(VodkaDetails.this, timologia_data);
