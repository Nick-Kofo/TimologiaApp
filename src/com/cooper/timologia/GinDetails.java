...
public class GinDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumGin();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε Gin= " + data);
		} else {
			sum.setText("Σύνολο σε Gin= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_GinDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(GinDetails.this, timologia_data);
