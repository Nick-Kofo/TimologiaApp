...
public class OuiskiaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumOuiskia();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε ουϊσκι= " + data);
		} else {
			sum.setText("Σύνολο ουϊσκι= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_OuiskiaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(OuiskiaDetails.this, timologia_data);
