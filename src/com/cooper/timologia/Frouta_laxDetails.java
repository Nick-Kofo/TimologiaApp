...
public class Frouta_laxDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumFrouta_lax();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο φρούτων-λαχανικών= " + data);
		} else {
			sum.setText("Σύνολο φρούτων-λαχανικών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Frouta_laxDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Frouta_laxDetails.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									Frouta_laxDetails.this.onResume();
