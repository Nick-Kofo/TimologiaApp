...
public class TirokomikaDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumTirokomika();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των τυροκομικών= " + data);
		} else {
			sum.setText("Σύνολο τυροκομικών= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_TirokomikaDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(TirokomikaDetails.this, timologia_data);
					...
					adb.setPositiveButton("Ok",
							new AlertDialog.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									TirokomikaDetails.this.onResume();
