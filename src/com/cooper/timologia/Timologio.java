...
public class Timologio extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		add_btn_tim.setOnClickListener(new View.OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent add_tim = new Intent(Timologio.this,
						Add_Update_Tim.class);
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumAll();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο όλων των τιμολογίων= " + data);
		} else {
			sum.setText("Σύνολο= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Timologia();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Timologio.this, timologia_data);
