...
public class TsaiDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumTsai();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε τσάι= " + data);
		} else {
			sum.setText("Σύνολο σε τσάι= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_TsaiDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(TsaiDetails.this, timologia_data);
