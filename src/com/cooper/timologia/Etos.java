...
public class Etos extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumEtos();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο τωρινού έτους= " + data);
		} else {
			sum.setText("Σύνολο τωρινού έτους= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Etos();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Etos.this, timologia_data);
