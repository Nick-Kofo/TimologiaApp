...
public class RumDetails extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumRum();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο σε ρούμι= " + data);
		} else {
			sum.setText("Σύνολο σε ρούμι= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_RumDetails();
		...
		db.close();
		tAdapter = new Timologia_Adapter(RumDetails.this, timologia_data);
