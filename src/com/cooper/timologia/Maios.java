...
public class Maios extends Activity {
	...
	private void Set_Sum_Tim() {
		...
		String data = db.getSumMai();
		db.close();
		if (data != null) {
			sum.setText("Σύνολο Μαϊου= " + data);
		} else {
			sum.setText("Σύνολο Μαϊου= 0");
		}
	}
	...
	public void Set_Referash_Data() {
		...
		db = new DatabaseHandler(this);
		ArrayList<Timologia> timologia_array_from_db = db.Get_Maio();
		...
		db.close();
		tAdapter = new Timologia_Adapter(Maios.this, timologia_data);
